...
import org.lins.mmmjjkx.rykenslimefuncustomizer.customs.menu.RSCClickHandler;
...
public class ScriptMachineNoEnergy extends AbstractEmptyMachine<MachineOperation> {
            ...
            addItemHandler(
                    new BlockPlaceHandler(false) {
                        ...
                        public void onPlayerPlace(@NonNull BlockPlaceEvent e) {
                            ScriptMachineNoEnergy.this.eval.evalFunction("onPlace", e);
                        }
                    },
                (BlockUseHandler) e -> ScriptMachineNoEnergy.this.eval.evalFunction("onUse", e),
                    new BlockBreakHandler(false, false) {
                        ...
                        public void onPlayerBreak(
                            ...
                            ScriptMachineNoEnergy.this.eval.evalFunction("onBreak", e, item, drops);
                        }
                    });
        }
    ...
    protected void tick(Block b, SlimefunItem item, SlimefunBlockData data) {
        ...
        if (eval != null) {
            TickContextScriptMachineNoEnergy info = new TickContextScriptMachineNoEnergy(data.getBlockMenu(), data, this, item, b, processor);
    ...
    public BlockTicker getBlockTicker() {
        return new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem item, SlimefunBlockData data) {
                ScriptMachineNoEnergy.this.tick(b, item, data);
            }
        };
    }
