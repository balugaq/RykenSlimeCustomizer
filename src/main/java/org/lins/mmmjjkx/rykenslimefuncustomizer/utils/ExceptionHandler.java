...
public class ExceptionHandler {
    ...
    public static HandleResult handleIdConflict(String id) {
        ...
        if (i != null) {
            console.sendMessage(decorate(CMIChatColor.translate(
        ...
        if (ig != null) {
            ...
            if (ig.getAddon() != null) {
                if (ig.getAddon().getClass() == RykenSlimefunCustomizer.class) {
                    console.sendMessage(decorate(CMIChatColor.translate(text)));
                    return HandleResult.FAILED;
                }
                return HandleResult.SUCCESS;
            }
    ...
    public static void handleWarning(String message) {
        ...
        console.sendMessage(decorate(CMIChatColor.translate("&eWARNING | " + message)));
    }

    public static void handleError(String message) {
        if (message == null || message.isBlank()) return;

        console.sendMessage(decorate(CMIChatColor.translate("&4ERROR | " + message)));
    }
    ...
    public static void handleError(String message, Throwable e) {
        ...
        if (e != null) {
            ...
            RykenSlimefunCustomizer.INSTANCE
                    .getComponentLogger()
                    .error(LegacyComponentSerializer.legacyAmpersand().deserialize(decorate("&4ERROR | " + message)), e);
        } else {
            handleError(message);
        }
    }
    ...
    public static void handleDanger(String message) {
        ...
        console.sendMessage(decorate(CMIChatColor.translate("&c&u&l&bD&4&lA&c&lN&b&lG&4&lE&c&lR | " + message)));
    }
