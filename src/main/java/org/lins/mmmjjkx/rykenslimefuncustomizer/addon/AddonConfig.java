...
public record AddonConfig(File configFile, YamlConfiguration config, ScriptEval onReloadHandler) {
    public AddonConfig(File configFile, YamlConfiguration config, @Nullable ScriptEval onReloadHandler) {
